(function () {
    ...
    // Saves the selected cities to local storage
    ...
    app.getForecast = function (key, label) {
        ...
        if (caches) {
            caches.match(url).then(function (response) {
                if (response && app.requestPending) {
    ...
    if ('serviceWorker' in navigator) {
        // The url specifies what level of the site should this service worker monitor.
        // In this case, the service worker is registered at the root, so it will cover
        // everything at the root.
        // This would mean that you would need to place the service-worker.js file in the
        // directory location that you want to monitor, because this is also the path
        // at which it will look for the service-worker.js file.
